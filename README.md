...
[![GitHub](https://github.com/xiddjp/opcua-private/workflows/gopuca/badge.svg)](https://github.com/xiddjp/opcua-private/actions)
[![Go Reference](https://pkg.go.dev/badge/github.com/xiddjp/opcua-private.svg)](https://pkg.go.dev/github.com/xiddjp/opcua-private)
[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/xiddjp/opcua-private/blob/master/LICENSE)
[![Version](https://img.shields.io/github/tag/gopcua/opcua.svg?color=blue&label=version)](https://github.com/xiddjp/opcua-private/releases)

## Note

`v0.2.4` and `v0.2.5` are broken and should not be used. Please upgrade to `v0.2.6` or later.
See [#538](https://github.com/xiddjp/opcua-private/issues/538) for details.
...
# install library
go get -u github.com/xiddjp/opcua-private
...
The [Current State](https://github.com/xiddjp/opcua-private/wiki/Current-State) was moved
to the [Wiki](https://github.com/xiddjp/opcua-private/wiki).
...
The [Gopcua Team](https://github.com/xiddjp/opcua-private/graphs/contributors).
...
[MIT](https://github.com/xiddjp/opcua-private/blob/master/LICENSE)
