...
import (
	...
	"github.com/xiddjp/opcua-private/debug"
	"github.com/xiddjp/opcua-private/errors"
	"github.com/xiddjp/opcua-private/id"
	"github.com/xiddjp/opcua-private/stats"
	"github.com/xiddjp/opcua-private/ua"
	"github.com/xiddjp/opcua-private/uacp"
	"github.com/xiddjp/opcua-private/uasc"
)
...
// #Option for details.
//
// https://godoc.org/github.com/xiddjp/opcua-private#Option
//
...
func (c *Client) Connect(ctx context.Context) (err error) {
	...
	// todo(fs): see the discussion in https://github.com/xiddjp/opcua-private/pull/512
			...
			for action != none {
				...
				default:
					...
					case createSecureChannel:
						...
						// todo(fs): down.
						//
						// https://github.com/xiddjp/opcua-private/pull/470
						c.conn.Close()
...
func (c *Client) CloseWithContext(ctx context.Context) error {
	...
	// https://github.com/xiddjp/opcua-private/pull/462
	//
...
func (c *Client) ActivateSessionWithContext(ctx context.Context, s *Session) error {
	...
	return c.SecureChannel().SendRequestWithContext(ctx, req, s.resp.AuthenticationToken, func(v interface{}) error {
		...
		//
		// https://github.com/xiddjp/opcua-private/issues/474
		//
